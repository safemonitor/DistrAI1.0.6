/*
  ...
  1. Changes
    - Creates routes table for managing delivery and sales routes
    - Adds route management columns to deliveries table
    - Sets up sequence numbering for deliveries within routes
    - Adds necessary indexes and foreign key relationships
  
  2. Security
    - Enables RLS on routes table
    - Adds policies for route management with proper permission checks
    - Only admins can manage routes, while authenticated users can view them
*/
